...
class ImageBlog(models.Model):
    ...
    date_post = models.DateTimeField(auto_now_add=True, verbose_name="date post",null=True)
    date_change = models.DateTimeField(auto_now=True, verbose_name="date change",null=True)
    def __str__(self):
        return self.name_blog.title

class CommentBlog(models.Model):
    name_blog = models.ForeignKey(Blog,on_delete=models.CASCADE)
    author = models.ForeignKey(User,on_delete=models.CASCADE)
    comment_blog = models.TextField(max_length=200,null=False,blank=False)
...
class ReplyComment(models.Model):
    ...
    reply = models.TextField(max_length=200,null=False,blank=False)
    date_reply = models.DateTimeField(auto_now_add=True, verbose_name="date comment")
    date_change = models.DateTimeField(auto_now=True, verbose_name="date change")
    def __str__(self):
        return self.comment.name_blog